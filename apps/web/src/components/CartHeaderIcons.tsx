  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        ...
        {favoritesCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold rounded-full px-1.5 py-0.5 min-w-6 text-center">
            {favoritesCount}
          </span>
        )}
      </Link>
      ...
      >
        ...
        {cartCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-[#ffd119] text-black text-xs font-bold rounded-full px-1.5 py-0.5 min-w-6 text-center">
            {cartCount}
          </span>
        )}
      </Link>
