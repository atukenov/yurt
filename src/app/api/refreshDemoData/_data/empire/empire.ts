...
const profile = {
  ...
  restaurantID: "empire",
  description:
    "Casual Dining - Kerala, Biryani, North Indian, South Indian, Chinese, Arabian, Seafood",
  addresses: ["Koramangala, Benagaluru", "Jayanagar, Benagaluru"],
  themeColor: { h: 347, s: 76, l: 19 },
  avatar:
    "https://lh3.googleusercontent.com/6pc0PrmxaBRy3IQNzdtCWW86iCecUOM7GXJnEKIIi56mtJ5nl1OCo_ZwjyaxtTsDstg3l1GUkH_95158smqRIrwtDSPvP_iX9Upd7E9c",
  cover:
